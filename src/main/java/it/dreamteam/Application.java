...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        if (choice==1 || choice==2) {
            ...
            Vehicle vehicle = new Vehicle(VehicleType.BUS, 50, VehicleStatus.IN_SERVIZIO);
            vd.save(vehicle);
                ...
                switch (choice3) {
                    case 1:
                        if (choice == 1) {
                            ...
                            System.out.println("Non hai biglietti");
                    ...
                    case 2:
                        if (choice == 2) {
                            ...
                            System.out.println("Non hai alcun abbonamento");
        ...
        }else System.out.println("Grazie, Arrivederci");
